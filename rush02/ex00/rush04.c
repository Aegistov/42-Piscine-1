...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2016/07/31 13:48:28 by huspinat          #+#    #+#             */
/*   Updated: 2016/07/31 21:28:35 by huspinat         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int		ft_print_corner04(int *xy, int width, int height, char *str)
{
	if (xy[1] == 1 && xy[0] == 1)
		str[0] = TL;
...
char	*rush04(int a, int b)
{
	...
	while (xy[0]++ < b)
	{
		while (xy[1]++ < a)
		{
			if (ft_print_corner04(xy, a, b, str + i + 1))
				i++;
