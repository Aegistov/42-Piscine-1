...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2016/07/31 13:47:22 by huspinat          #+#    #+#             */
/*   Updated: 2016/07/31 21:27:37 by huspinat         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int		ft_print_corner01(int *xy, int width, int height, char *str)
{
	if (xy[1] == 1 && xy[0] == 1)
		str[0] = TL;
...
char	*rush01(int a, int b)
{
	...
	while (xy[0]++ < b)
	{
		while (xy[1]++ < a)
		{
			if (ft_print_corner01(xy, a, b, str + i + 1))
				i++;
