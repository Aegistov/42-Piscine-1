...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2016/07/31 13:47:59 by huspinat          #+#    #+#             */
/*   Updated: 2016/07/31 21:27:56 by huspinat         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int		ft_print_corner02(int *xy, int width, int height, char *str)
{
	if (xy[1] == 1 && xy[0] == 1)
		str[0] = TL;
...
char	*rush02(int a, int b)
{
	...
	while (xy[0]++ < b)
	{
		while (xy[1]++ < a)
		{
			if (ft_print_corner02(xy, a, b, str + i + 1))
				i++;
